...
const config = {
  ...
  smtpUser: process.env.SMTP_USER || process.env.GMAIL_USER || 'ahmedmusthaffa02@gmail.com',
  smtpPass: process.env.SMTP_PASS || process.env.GMAIL_APP_PASSWORD || 'hdvx clye uamu ouqa',
